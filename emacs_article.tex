...
%% Last-Updated: 六 12月 27 21:32:38 2014 (+0800)
%%           By: Hongyi Wu(吴鸿毅)
%%     Update #: 46
...
\usepackage[cm-default]{fontspec}%选项[cm-default]主要用来解决使用数学环境时数学符号不能正常显示的问题。fontspec使用其提供的 \setmainfont 命令可设定文稿正文中的中文字体
